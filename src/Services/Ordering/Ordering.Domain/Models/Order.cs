...
public class Order : Aggregate<OrderId>
{
    ...
    public IReadOnlyList<OrderItem> OrdersItems => _ordersItems.AsReadOnly();
    ...
    public void Add(ProductId productId, int quantity, decimal price)
    {
        ...
        var ordersItem = new OrderItem(Id, productId, quantity, price);
        _ordersItems.Add(ordersItem);
    }

    public void Remove(ProductId productId)
    {
        var orderItem = _ordersItems.FirstOrDefault(x => x.ProductId == productId);
