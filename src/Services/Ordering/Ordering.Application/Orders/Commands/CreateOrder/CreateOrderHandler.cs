...
public class CreateOrderHandler(IApplicationDbContext dbContext) : ICommandHandler<CreateOrderCommand, CreateOrderResult>
{
    ...
    private Order CreateNewOrder(OrderDto orderDto)
    {
        ...
        var billingAddress = Address.Of(orderDto.BillingAddress.FirstName, orderDto.BillingAddress.LastName,
                    orderDto.BillingAddress.EmailAddress, orderDto.ShippingAddress.AddressLine, orderDto.BillingAddress.Country,
        ...
        foreach (var orderItemDto in orderDto.OrdersItems)
        {
