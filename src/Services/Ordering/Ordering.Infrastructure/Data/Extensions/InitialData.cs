...
internal class InitialData
{
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("mehmet", "ozkaya", "mehmet@gmail.com", "Bahcelievler No:4", "Turkey", "Istambul", "38050");
            var address2 = Address.Of("john", "doe", "john@gmail.com", "Brodaway No:1", "England", "Notthingham", "08050");

            var payment1 = Payment.Of("mehmet", "555555555555555554444", "12/28", "355", 1);
            var payment2 = Payment.Of("john", "888888888888555554444", "06,30", "222", 2);
